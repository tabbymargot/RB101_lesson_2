...
# Verify that the input string is a positive number (either an integer or a float)
...
loop do 
  prompt("Please enter your mortgage loan amount using only numbers (no currency symbols or decimal points):")
  ...
  if validate_number(loan_amount_input) 
    ...
    puts "That is not a valid amount. Please try again, making sure you are only entering whole numbers."
  end

end

puts "We will now ask you to enter the duration of your loan. At the first prompt, please enter the duration in years. At the second prompt, add any additional months. For example, if you loan is for 6 years and 3 months, enter 6 at the first prompt and 3 at the second. Please only enter whole numbers." 
puts "-------------------------------"
...
loop do
  prompt("Please enter the duration of your loan in years. If the duration is for less than 12 months, enter 0 .")
  ...
  if validate_whole_number(loan_duration_in_years_input)
    ...
    puts "That is not a valid duration. Please try again, making sure you are only entering whole numbers."
  end
  
  # puts loan_duration_in_years
end
...
loop do
  prompt("Please enter any additional months. If there are no additional months, enter 0 .")
